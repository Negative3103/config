...
func (x *CreateResuest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateResuest) ProtoMessage() {}

func (x *CreateResuest) ProtoReflect() protoreflect.Message {
	mi := &file_note_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreateResuest.ProtoReflect.Descriptor instead.
func (*CreateResuest) Descriptor() ([]byte, []int) {
	return file_note_proto_rawDescGZIP(), []int{3}
}

func (x *CreateResuest) GetInfo() *NoteInfo {
	if x != nil {
		return x.Info
	}
	return nil
...
var file_note_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x52, 0x65, 0x73, 0x75, 0x65, 0x73, 0x74, 0x12, 0x25, 0x0a, 0x04, 0x69, 0x6e, 0x66,
	...
	0x76, 0x31, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x52, 0x65, 0x73, 0x75, 0x65, 0x73, 0x74,
	...
	0x6f, 0x6d, 0x2f, 0x4e, 0x65, 0x67, 0x61, 0x74, 0x69, 0x76, 0x65, 0x33, 0x31, 0x30, 0x33, 0x2f,
	0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x6e, 0x6f, 0x74, 0x65, 0x5f,
	0x76, 0x31, 0x3b, 0x6e, 0x6f, 0x74, 0x65, 0x5f, 0x76, 0x31, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_note_proto_goTypes = []interface{}{
	...
	(*CreateResuest)(nil),          // 3: note_v1.CreateResuest
...
var file_note_proto_depIdxs = []int32{
	...
	0,  // 7: note_v1.CreateResuest.info:type_name -> note_v1.NoteInfo
	...
	3,  // 11: note_v1.NoteV1.Create:input_type -> note_v1.CreateResuest
